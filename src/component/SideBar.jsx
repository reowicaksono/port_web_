...
const SideBar = ({isDarkMode}) => {
  return (
    <>
        <div className={`w-1/3 xl:w-1/4 h-[80%] fixed ml-6 top-1/2 transform -translate-y-1/2 flex flex-col justify-center items-center bg-[#111]  p-8 rounded-3xl  ${isDarkMode ? 'dark:bg-[#0b0b0d] dark:text-gray-100 shadow-[0_0_40px_rgba(255,255,255,0.2)]' : 'bg-white text-black shadow-[0_0_40px_rgba(0,0,0,0.2)]'}`}>
